...
app.whenReady().then(async () => {
    ...
    if (!isElevated) {
        dialog.showErrorBox('Insufficient privileges / Privilegios insuficientes', 'All Updater requires Administrator permissions to manage Winget and create restore points.\n\nAll Updater requiere permisos de Administrador para gestionar Winget y crear puntos de restauracion.');
        app.quit();
        return;
    }
